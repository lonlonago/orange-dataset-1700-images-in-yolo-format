# Orange dataset (1700 images in YOLO format

# Body

Orange dataset, 1700 images in YOLO format, clear images, complete annotations, suitable for target detection, image segmentation, algorithm performance improvement and other projects, ready to use, saves time and effort.
